...
export class HDMISwitchPlatformAccessory {
  ...
  public constructor(
    ...
    this.zeroIndexed = c.zeroIndexed || false;
    ...
    this.tvService
      ...
      .on(
        ...
        this.getActiveIdentifier.bind(this)
      )
      .on(
        this.api.hap.CharacteristicEventTypes.SET,
        this.setActiveIdentifier.bind(this)
      );
